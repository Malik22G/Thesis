  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -left-40 w-80 h-80 rounded-full bg-gradient-to-r from-purple-300/20 to-pink-300/20 blur-3xl" />
        <div className="absolute top-20 right-10 w-72 h-72 rounded-full bg-gradient-to-r from-blue-300/20 to-cyan-300/20 blur-3xl" />
        <div className="absolute bottom-10 left-1/3 w-96 h-96 rounded-full bg-gradient-to-r from-amber-300/20 to-orange-300/20 blur-3xl" />
      </div>
